...
// 		if($count < 5){
// 			$this->content->text .= "<span><img alt='' class='smallicon navicon' title='' src='" . $OUTPUT->image_url ('i/navigationitem') . "'><a class='jobs-listing-link' href='" . $value->DetailsUrl . "' target='_blank'>" . $value->Title . "</a></span>";
// 		}
// 		$count++;
// 	}
